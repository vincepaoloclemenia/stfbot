...
json.companies do |json|
    json.array! @companies do |company|
        ...
        json.user_first_name company.users.find_by_role('company_admin').first_name
        json.user_last_name company.users.find_by_role('company_admin').last_name
        json.user_email company.users.find_by_role('company_admin').email
        json.user_username company.users.find_by_role('company_admin').username
